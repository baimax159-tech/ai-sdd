...
| 类别 | skill 列表 |
|---|---|
| 语言核心 | golang-context、golang-naming、golang-structs-interfaces、golang-how-to、golang-popular-libraries |
...
| samber 生态 | golang-samber-lo、golang-samber-do、golang-samber-oops、golang-samber-mo、golang-samber-ro、golang-samber-hot、golang-samber-slog（使用了对应库时推荐） |
| 文档/更新 | golang-documentation、golang-stretchr-testify、golang-troubleshooting、golang-pkg-go-dev、golang-stay-updated |
